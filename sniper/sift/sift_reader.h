...
namespace Sift
{
   ...
   class Reader
   {
      ...
      typedef void (*HandleMallocEnterFunc)(void* arg, uint64_t pointer, uint64_t size);
      typedef void (*HandleCallocEnterFunc)(void* arg, uint64_t pointer, uint64_t size);
      typedef void (*HandleReallocEnterFunc)(void* arg, uint64_t init_pointer, uint64_t pointer, uint64_t size);
      typedef void (*HandleFreeEnterFunc)(void* arg, uint64_t pointer);
	 ...
	 HandleMallocEnterFunc handleMallocEnterFunc;
	 void *handleMallocEnterArg;
	 HandleCallocEnterFunc handleCallocEnterFunc;
	 void *handleCallocEnterArg;
	 HandleReallocEnterFunc handleReallocEnterFunc;
	 void *handleReallocEnterArg;
	 HandleFreeEnterFunc handleFreeEnterFunc;
	 void *handleFreeEnterArg;
      ...
      public:
         ...
         void setHandleMallocEnterFunc(HandleMallocEnterFunc func, void* arg = NULL) { assert(func); handleMallocEnterFunc = func; handleMallocEnterArg = arg;}
         void setHandleCallocEnterFunc(HandleCallocEnterFunc func, void* arg = NULL) { assert(func); handleCallocEnterFunc = func; handleCallocEnterArg = arg;}
         void setHandleReallocEnterFunc(HandleReallocEnterFunc func, void* arg = NULL) { assert(func); handleReallocEnterFunc = func; handleReallocEnterArg = arg;}
	 void setHandleFreeEnterFunc(HandleFreeEnterFunc func, void* arg = NULL) { assert(func); handleFreeEnterFunc = func; handleFreeEnterArg = arg;}
